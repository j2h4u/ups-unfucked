...
# or a deliberately-kept symbol. Keep the rationale current. Reviewed 2026-05-31.
...
_.get_weighted_estimate  # KEEP: CAP-02 weighted-capacity API, no consumer yet (product decision)
