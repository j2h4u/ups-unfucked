...
- [ ] **Phase 2: Battery Model — State Estimation & Event Classification** (2/6 plans complete) - Build battery model, estimate SoC/runtime, distinguish blackout from test
